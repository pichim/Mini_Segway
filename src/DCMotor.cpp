...
DCMotor::motor_signals_t DCMotor::read()
{
    motor_signals_t motor_signals;
    motor_signals.counts = getEncoderCount();
    motor_signals.velocity = getVelocity();
    motor_signals.rotations = getRotation();
    motor_signals.voltage = getVoltage();
